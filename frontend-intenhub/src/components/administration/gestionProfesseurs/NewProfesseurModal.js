...
export default function NewStudentModal() {
  ...
  function onSubmit(data) {
    console.log(data);
    axios.post("http://localhost:8080/professor/add", data).then((res) => {
            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="mb-3">
                  ...
                  <input
                    type="text"
                    {...register("nomProf", { required: true })}
              ...
              <div className="col-lg-4">
                <div className="mb-3">
                  ...
                  <input
                    type="text"
                    {...register("prenomProf", { required: true })}
                    className="form-control"
                  />
                </div>
              </div>
              <div className="col-lg-4">
                <div className="mb-3">
                  ...
                  <select
                    class="form-select"
                    {...register("genreProf", { required: true })}
                  >

  ...
  return (
    <tbody className="table-tbody">
      {competences.map((competence) => (
        ...
        <td><button className="btn btn-warning w-100" data-bs-toggle="modal" data-bs-target={`#modal-${competence.codeCompetence}`}>
            Détails
        </button></td>
        ...
        <div className="modal modal-blur fade" id={`modal-${competence.codeCompetence}`} tabIndex={-1} aria-hidden="true" style={{display: 'none'}}>
          <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
            <form className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Détails de la compétence {competence.codeCompetence}</h5>
            ...
            <div className="col-lg-12">
              <div className="mb-3">
                <label className="form-label">Label de la compétence</label>
                <input type="text" defaultValue={competence.libelle} className="form-control" disabled/>
              </div>
            </div>
            <div className="col-lg-12">
              <div className="mb-3">
                <label className="form-label">Description de la compétence</label>
                <textarea type="text" defaultValue={competence.description} className="form-control" disabled/>
              </div>
            </div>
              </div>
              </div>
